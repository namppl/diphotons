            ...
            option_groups=[
                ("Bias study options", [
                        ...
                        make_option("--bias-param",dest="bias_param",action="callback",type="string",callback=optpars_utils.Load(scratch=True),
                                    default={
                                "ee_dijet_200_3500"      : "TMath::Min(0.1, 4e9*x^(-4)+0.001)",
                                "mm_dijet_200_3500"      : "TMath::Min(0.1, 4e9*x^(-4)+0.001)",
                                "allZG_dijet_200_3500"   : "TMath::Min(0.1, 4e9*x^(-4)+0.001)",
                                "_ee_dijet_200_3500"      : "(33000.*x^(-2.))",
                                "_mm_dijet_200_3500"      : "(33000.*x^(-2.))",
                                "_allZG_dijet_200_3500"   : "(33000.*x^(-2.))",
                                "__ee_dijet_200_2500"      : "(x>600.)*(50000.*x^(-2.5) + 0.0001)",
                                "__mm_dijet_200_2500"      : "(x>600.)*(50000.*x^(-2.5) + 0.0001)",
                                "__allZG_dijet_200_2500"   : "(x>600.)*(50000.*x^(-2.5) + 0.0001)",
